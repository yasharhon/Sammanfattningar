...
Suppose that we transform the basis according to
\begin{align*}
	(\tb{}^{\prime})^{a_{i}} = L_{b_{i}}^{a_{i}}\tb{b_{i}}.
\end{align*}
The components of the tensor then transform according to
\begin{align*}
	T((\tb{}^{\prime})^{a_{1}}, \dots, (\tb{}^{\prime})^{a_{n}}) &= T(L_{b_{1}}^{a_{1}}\tb{b_{1}}, \dots, L_{b_{n}}^{a_{n}}\tb{b_{n}}) \\
	                                                             &= L_{b_{1}}^{a_{1}}\dots L_{b_{n}}^{a_{n}}T(\tb{b_{1}}, \dots, \tb{b_{n}}) \\
	                                                             &= L_{b_{1}}^{a_{1}}\dots L_{b_{n}}^{a_{n}}T^{a_{1}, \dots, a_{N}}.
\end{align*}
...
The metric tensor $g$ is a rank $2$ tensor defined by $g(\vb{v}, \vb{w}) = \vb{v}\cdot\vb{w}$. It is a symmetric tensor. Its components satisfy
\begin{align*}
