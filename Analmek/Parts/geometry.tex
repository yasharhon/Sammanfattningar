...
\end{align*}
Summation of the first term over $a$ gives $g_{ac}g^{cd}\ddot{\chi}^{a} = g_{ca}g^{cd}\ddot{\chi}^{a} = g^{cd}\ddot{\chi}_{c}$, and summation over $c$ gives $g^{cd}\ddot{\chi}_{c} = g^{cd}\ddot{\chi}^{d}$. This thus yields
\begin{align*}
