...
Låt nu $n$ vara givet och välj ett $N$ så att $n < N$ och $\sum\limits_{\abs{n} > N}\abs{c_{n}} < \varepsilon$, vilket är möjligt eftersom serien ovan är konvergent. Detta ger
\begin{align*}
