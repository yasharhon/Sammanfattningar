...
\newcommand{\Sym}[2][]{\text{Sym}^{#1}(#2)}
\newcommand{\Alt}[2][]{\text{Alt}^{#1}(#2)}
...
\input{./Parts/multilinear_algebra.tex}

\input{./Parts/outer_algebra.tex}

\input{./Parts/field_extension.tex}
