...
\begin{align*}
	\inteval{0}{a}{\abs{B}^{2}\sin^{2}{kx}}{x} = 1.
\end{align*}
Integralen på vänstersidan är
\begin{align*}
	\abs{B}^{2}\inteval{0}{a}{\frac{1 - \cos{2kx}}{2}}{x}.
\end{align*}
...
\paragraph{Tunneling}
Klassiskt kan en partikel inte kryssa en barriär om den har för låg energi. Kvantmekaniskt ger Schrödingerekvationen
\begin{align*}
	T \approx 16\frac{E}{V_{0}}(1 - \frac{E}{V_{0}})e^{-2a\sqrt{2m(V_{0} - E)}}, E < V_{0}, a >> \delta
\end{align*}
Förklarar $\alpha$-sönderfall, STM och varför Solen brinner (fusion beskrivs av tunneling).