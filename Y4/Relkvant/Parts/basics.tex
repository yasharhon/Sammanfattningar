...
We have already studied the objects $J^{i}$, which satisfy the Lie algebra of \SU{2}, and may therefore be taken to correspond to angular momentum. As we saw above, the $\sigma_{\mu\nu}$ generate the Lorentz group represented on spinors, hence the operator
\begin{align*}
...
We intuitively see that $h$ should have eigenvalues $\pm 1$, but let us show this more clearly. We have
\begin{align*}
...
\paragraph{Connecting Helicity and Chirality}
...
To study antiparticles, we note that according to the previous derivations,
\begin{align*}
